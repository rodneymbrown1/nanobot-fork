...
from core import __version__, __logo__
from core.config.schema import Config
from core.cli.invite import invite_app
...
@app.command()
def deploy(
    instance: str = typer.Option("nanobot", "--instance", help="Instance name (e.g. nanobot, nano-beta)"),
    ...
    from core.cli.deploy import DeployFlow
...
def identity_pull():
    ...
    from core.agent.identity import sync_identity, IDENTITY_FILES
...
def identity_push():
    ...
    from core.config.loader import load_config
    from core.agent.identity import push_identity
...
def identity_status_cmd():
    ...
    from core.config.loader import load_config
    from core.agent.identity import identity_status
...
def notion_auth():
    ...
    from core.config.loader import load_config, save_config
