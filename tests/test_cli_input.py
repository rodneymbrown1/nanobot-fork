...
def mock_prompt_session():
    ...
    with patch("core.cli.commands._PROMPT_SESSION", mock_session), \
         patch("core.cli.commands.patch_stdout"):
        yield mock_session
...
def test_init_prompt_session_creates_session():
    ...
    with patch("core.cli.commands.PromptSession") as MockSession, \
         patch("core.cli.commands.FileHistory") as MockHistory, \
